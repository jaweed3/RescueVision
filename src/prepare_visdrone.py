...
# ============================================================
RAW_TRAIN_IMAGES = Path("raw_data/VisDrone2019-DET-train/images")
RAW_TRAIN_ANNOTS = Path("raw_data/VisDrone2019-DET-train/annotations")
RAW_VAL_IMAGES   = Path("raw_data/VisDrone2019-DET-val/images")
RAW_VAL_ANNOTS   = Path("raw_data/VisDrone2019-DET-val/annotations")
RAW_TEST_IMAGES  = Path("raw_data/VisDrone2019-DET-test-dev/images")
RAW_TEST_ANNOTS  = Path("raw_data/VisDrone2019-DET-test-dev/annotations")
...
def process_split(img_src: Path, ann_src: Path,
    ...
    if not img_src.exists():
        print(f"  [SKIP] {img_src} tidak ditemukan — pastikan VisDrone sudah didownload")
        return 0, 0, 0
...
def main():
    ...
    splits = [
        (RAW_TRAIN_IMAGES, RAW_TRAIN_ANNOTS, OUTPUT_TRAIN_IMG, OUTPUT_TRAIN_LBL, "train"),
